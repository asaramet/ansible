...
echo "== Updating Aruba Modular stacked switches - $(date)"
ansible --version
echo "Log file: ${logs_folder}/aruba_modular_stack.logs"
...
echo "== Done updating Aruba Modular stacked switches - $(date)"